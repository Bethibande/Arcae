package com.bethibande.arcae.web.management;
...
public class ManagementServer {
    ...
    public static final String MANAGEMENT_PORT_PROPERTY = "arcae.management.port";
    public static final String DISTRIBUTED_PROPERTY = "arcae.distributed";
